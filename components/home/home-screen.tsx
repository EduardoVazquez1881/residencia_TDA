        ...
        {query ? (
          <View style={{ gap: 24 }}>
            {alumnosFiltrados.length === 0 && casosFiltrados.length === 0 && bitacorasFiltradas.length === 0 && plantillasFiltradas.length === 0 ? (
              <View style={[styles.emptyState, { backgroundColor: isDark ? colors.backgroundSecondary : "#fff", shadowColor: "#000", shadowOpacity: isDark ? 0.1 : 0.04, shadowRadius: 10, shadowOffset: { width: 0, height: 2 }, elevation: 2 }]}>
                <Ionicons name="search-outline" size={38} color={colors.textSecondary} style={{ opacity: 0.4, marginBottom: 12 }} />
                <Text style={[styles.emptyTitle, { color: colors.text }]}>Sin resultados</Text>
                <Text style={[styles.emptyDesc, { color: colors.textSecondary }]}>No se encontró ninguna coincidencia con "{searchText}"</Text>
              </View>
            ) : (
              <>
                {/* Alumnos Section */}
                {alumnosFiltrados.length > 0 && (
                  <View>
                    ...
                    {alumnosFiltrados.map((alumno) => {
                      ...
                      const escuelaMeta = [alumno.escuela_actual, [alumno.grado_escolar, alumno.grupo_escolar].filter(Boolean).join(" - ")].filter(Boolean).join(" · ");
                      return (
                        <View key={alumno.alumno_id} style={[styles.recenteCard, { backgroundColor: isDark ? colors.backgroundSecondary : "#fff", shadowColor: "#000", shadowOpacity: isDark ? 0.12 : 0.05, shadowRadius: 10, shadowOffset: { width: 0, height: 2 }, elevation: 2, marginBottom: 16 }]}>
                          ...
                          <View style={styles.recenteInfo}>
                            ...
                            {escuelaMeta ? <Text style={[styles.recenteMeta, { color: colors.textSecondary }]} numberOfLines={1}>{escuelaMeta}</Text> : null}
                            {alumno.nivel_tea ? (
                ...
                {casosFiltrados.length > 0 && (
                  <View>
                    ...
                    {casosFiltrados.map((caso) => (
                      <View key={caso.caso_id} style={[styles.recenteCard, { backgroundColor: isDark ? colors.backgroundSecondary : "#fff", shadowColor: "#000", shadowOpacity: isDark ? 0.12 : 0.05, shadowRadius: 10, shadowOffset: { width: 0, height: 2 }, elevation: 2, marginBottom: 16 }]}>
                        ...
                        <View style={styles.recenteInfo}>
                          ...
                          {caso.plantillas?.nombre ? <Text style={[styles.recenteMeta, { color: colors.textSecondary }]} numberOfLines={1}>{caso.plantillas.nombre}</Text> : null}
                        </View>
                ...
                {bitacorasFiltradas.length > 0 && (
                  <View>
                    ...
                    {bitacorasFiltradas.map((bitacora) => (
                      <View key={bitacora.bitacora_id} style={[styles.recenteCard, { backgroundColor: isDark ? colors.backgroundSecondary : "#fff", shadowColor: "#000", shadowOpacity: isDark ? 0.12 : 0.05, shadowRadius: 10, shadowOffset: { width: 0, height: 2 }, elevation: 2, marginBottom: 16 }]}>
                ...
                {plantillasFiltradas.length > 0 && (
                  <View>
                    ...
                    {plantillasFiltradas.map((plantilla) => (
                      <View key={plantilla.plantilla_id} style={[styles.recenteCard, { backgroundColor: isDark ? colors.backgroundSecondary : "#fff", shadowColor: "#000", shadowOpacity: isDark ? 0.12 : 0.05, shadowRadius: 10, shadowOffset: { width: 0, height: 2 }, elevation: 2, marginBottom: 16 }]}>
                        ...
                        <View style={styles.recenteInfo}>
                          ...
                          {plantilla.descripcion ? <Text style={[styles.recenteMeta, { color: colors.textSecondary }]} numberOfLines={1}>{plantilla.descripcion}</Text> : null}
                        </View>
